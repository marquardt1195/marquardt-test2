...
#                          dateInput(paste0("entry_date_add", input$Add_row_head), "Entry Date", value = Sys.Date()),
...
#                          dateInput(paste0("exit_date_add", input$Add_row_head), "Exit Date", value = Sys.Date()),  
#                          dateInput(paste0("purchase_date_add", input$Add_row_head), "Purchase Date", value = Sys.Date()),  
#                          dateInput(paste0("sell_date_add", input$Add_row_head), "Sell Date", value = Sys.Date()),
